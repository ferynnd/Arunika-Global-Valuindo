                                            ...
                                            <tr key={item.id} className="hover:bg-[#FAF8F5]/80 transition-colors">
                                                ...
                                                <td className="px-6 py-4 text-right space-x-1.5">
                                                    <Link
                                                        ...
                                                        className="inline-flex px-3 py-1 rounded-xl text-xs font-semibold bg-[#EFECE6] text-[#1B544D] hover:bg-[#E3DFD7] transition-colors"
                                                    >
                                                        Detail
                                                    </Link>
                                                    <Link
                                                        href={route('admin.articles.edit', item.id)}
                                                        className="inline-flex px-3 py-1 rounded-xl text-xs font-semibold bg-[#1B544D]/10 text-[#1B544D] hover:bg-[#1B544D]/20 transition-colors"
                                                    >
                                                        Edit
                                                    </Link>
                                                    <button
                                                        onClick={() => handleDelete(item.id, item.title)}
                                                        className="inline-flex px-3 py-1 rounded-xl text-xs font-semibold bg-rose-50 text-rose-600 hover:bg-rose-100 transition-colors"
                                                    >
                                                        Hapus
                                                    </button>
                                                </td>
