      ...
      <section className="py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-7 bg-white p-8 sm:p-10 rounded-3xl md:rounded-2xl border border-[#EAE6DF] ">
          ...
          <div className="w-full mt-10 aspect-video rounded-3xl md:rounded-2xl overflow-hidden border border-[#EAE6DF] relative bg-slate-100">
            <iframe
