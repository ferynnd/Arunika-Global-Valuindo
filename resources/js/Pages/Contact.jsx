      ...
      <section className="py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-7 bg-background p-8 sm:p-10 rounded-3xl md:rounded-2xl border border-stone-200 ">
          ...
          <div className="w-full mt-10 aspect-video rounded-3xl md:rounded-2xl overflow-hidden border border-stone-200 relative bg-slate-100"  data-aos="fade-up">
            <iframe
