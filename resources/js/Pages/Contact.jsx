...
export default function Contact({ auth }) {
  ...
  return (
    <div className="min-h-screen bg-[#FAF8F5] text-[#334155] font-sans antialiased selection:bg-[#ECAE36] selection:text-primary">
      ...
      <Header auth={auth} activePage="contact" />
      ...
      {/* SECTION KONTAK (KIRI: INFO, KANAN: FORM WA) */}
      <section className="py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-5 space-y-8" data-aos="fade-right">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4 p-5 bg-white rounded-2xl md:rounded-xl border border-[#EAE6DF] hover:border-primary/40 transition-colors">
            ...
            <div className="lg:col-span-7 bg-white p-8 sm:p-10 rounded-3xl md:rounded-2xl border border-[#EAE6DF]" data-aos="fade-left">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-2xl md:rounded-xl bg-[#FAF8F5] border border-[#EAE6DF] text-sm focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-2xl md:rounded-xl bg-[#FAF8F5] border border-[#EAE6DF] text-sm focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all resize-none"
                  ></textarea>
                </div>
                ...
                <button
                  type="submit"
                  className="w-full inline-flex items-center justify-center gap-2 py-3.5 px-6 rounded-2xl md:rounded-xl bg-primary hover:bg-[#143F39] text-[#ECAE36] font-bold text-sm transition-all cursor-pointer"
                >
          ...
          <div className="w-full mt-10 aspect-video rounded-3xl md:rounded-2xl overflow-hidden border border-[#EAE6DF] relative bg-slate-100" data-aos="fade-up">
            <iframe
