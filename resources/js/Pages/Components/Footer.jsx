                    ...
                    <div className="lg:col-span-2 space-y-4">
                        ...
                        <ul className="space-y-3 text-sm tracking-wide text-slate-400">
                            <li className="flex items-start gap-2.5">
                                ...
                                <a href="tel:+62215550198" className="hover:text-secondary transition-colors">+62 (21) 555-0198</a>
                            </li>
                            <li className="flex items-start gap-2.5">
                                <svg className="w-4 h-4 text-secondary shrink-0 mt-0.5" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                </svg>
                                <a href="mailto:contact@arunika-valuindo.com" className="hover:text-secondary transition-colors break-all">contact@arunika-valuindo.com</a>
                            </li>
                            <li className="flex items-start gap-2.5">
                                <svg className="w-4 h-4 text-secondary shrink-0 mt-0.5" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24">
