            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-12 pb-14 border-b border-[#1A3D36]">
                    ...
                    <div className="lg:col-span-2 space-y-4">
                        ...
                        <div className="pt-2 flex items-center gap-3">
                            <a href="https://instagram.com" target="_blank" rel="noreferrer" className="w-8 h-8 rounded-full bg-[#16352E] text-slate-300 hover:bg-[#ECAE36] hover:text-[#1B544D] transition-all flex items-center justify-center" aria-label="Instagram">
                            ...
                            <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="w-8 h-8 rounded-full bg-[#16352E] text-slate-300 hover:bg-[#ECAE36] hover:text-[#1B544D] transition-all flex items-center justify-center" aria-label="LinkedIn">
                            ...
                            <a href="https://twitter.com" target="_blank" rel="noreferrer" className="w-8 h-8 rounded-full bg-[#16352E] text-slate-300 hover:bg-[#ECAE36] hover:text-[#1B544D] transition-all flex items-center justify-center" aria-label="Twitter">
                                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                                </svg>
                            </a>
                            <a href="mailto:contact@arunika-valuindo.com" className="w-8 h-8 rounded-full bg-[#16352E] text-slate-300 hover:bg-[#ECAE36] hover:text-[#1B544D] transition-all flex items-center justify-center" aria-label="Email Us">
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24">
                ...
                <div className="pt-8 flex flex-col sm:flex-row items-center justify-between text-xs font-light tracking-wide text-slate-500 gap-4">
                    ...
                    <div className="flex items-center gap-4">
                        <Link href={route('privacypolicy')} className="hover:text-[#ECAE36] transition-colors">Privacy Policy</Link>
                    </div>
                </div>
