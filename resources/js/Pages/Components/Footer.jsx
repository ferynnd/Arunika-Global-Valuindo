                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 lg:gap-10 pb-14">
                    <div className="lg:col-span-2 space-y-4">
                        ...
                        <div className="pt-2 flex items-center gap-3">
                            <a href="https://www.instagram.com/arunikaglobalvaluindo" target="_blank" rel="noreferrer" className="w-8 h-8 rounded-full bg-[#1B544D] text-secondary hover:bg-[#1B544D]/80 transition-all flex items-center justify-center" aria-label="Instagram">
                            ...
                            <a href="https://www.linkedin.com/company/arunika-global-valuindo/home/" target="_blank" rel="noreferrer" className="w-8 h-8 rounded-full bg-[#1B544D] text-secondary hover:bg-[#1B544D]/80 transition-all flex items-center justify-center" aria-label="LinkedIn">
                            ...
                            <a href="mailto:arunikaglobalvaluindo@gmail.com" className="w-8 h-8 rounded-full bg-[#1B544D] text-secondary hover:bg-[#1B544D]/80 transition-all flex items-center justify-center" aria-label="Email Us">
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24">
